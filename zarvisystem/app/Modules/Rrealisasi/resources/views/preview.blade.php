...
@section('content')
    ...
    <h1 class="page-header">Laporan Realisasi  <small>Per Unit</small></h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
				...
				<h4 class="panel-title text-center m-b-15">Laporan Realisasi <br/>
                        ...
                        <div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									@foreach($data2 as $r)
										<tr> 
											<td class="text-center text-nowrap font-weight-bold text-warning">{{  number_format($r->unit) }}</td>
											<td class="text-center text-nowrap font-weight-bold text-warning">{{  number_format($r->total) }}</td>
										</tr>
										<?php $no++; ?>
									@endforeach 
								...
								<tbody>
									...
									@foreach($data as $r)
										<tr>
											...
											<td class="text-nowrap text-center">{{ App\Helpers\Tanggal::tgl_indo($r->tanggal_real) }}</td>
