...
@foreach($data as $r)
@endforeach
<h3 class="m-b-20">SPK  <small>View</small></h3>
        ...
        <div class="col-xl-6">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-6">
                ...
                <div class="panel-body">
                    <div class="form-group row m-l-15">
                        ...
                        <div class="col-md-7">
                        <input type="text" id="tipe" value="Pembangunan Rumah" class="form-control">
                        </div>
                    </div>
         ...
         <div class="col-xl-6">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
                <!-- begin panel-heading -->
                <div class="panel-heading">
                <h4 class="panel-title"><span class="label label-success">Data Unit</span></h4>
                    <div class="panel-heading-btn">
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-redo"></i></a>
                        <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
                ...
                <div class="panel-body">
                 ...
                 <div class="panel pagination-grey clearfix m-b-0">
                     ...
                     @endforeach
                            <tr>
                             <td class="text-center font-weight-bold text-green text-nowrap" colspan="2">Total</td>
                             <td class="text-right text-nowrap font-weight-bold text-green text-nowrap">Rp {{ number_format($r->gross_total) }}</td>
                         </tr>
                         </tbody>
