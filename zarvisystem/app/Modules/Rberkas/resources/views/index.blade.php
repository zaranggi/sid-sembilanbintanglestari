...
<h1 class="page-header">Laporan <small>Proses KPR...</small></h1>
         ...
         <div class="col-lg-6">
            ...
            <div class="widget"> 
                ...
                <div class="my-3"></div> 
                    ...
                    @endif 
               <form class="form-horizontal" role="form" method="POST" action="{{ url('/rberkas/preview') }}">
					...
					<div class="form-group m-b-5">
                        <label class="col-lg-3 col-form-label">Status KPR</label>
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-home  text-info"></i></span>
                            <select class="default-select2 form-control" name="status_kpr" required>
                                <option value="baru">MOU Baru</option> 
                                <option value="proses">Proses Pengajuan</option> 
                                <option value="acc">ACC / SP3K</option> 
                                <option value="realisasi">Realiasi</option>  
                            </select>
                        </div>
                    </div> 
