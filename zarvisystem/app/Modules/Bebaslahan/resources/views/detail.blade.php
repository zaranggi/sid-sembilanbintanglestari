...
<div class="section-container section-with-top-border p-b-5">  
    ...
    <form id="bebaslahan" class="formku" method="POST" action="javascript:void(0)">
        ...
        <input type="hidden" name="id" value="{{ $xx->id }}"> 
        @if ( count( $errors ) > 0 ) 
                ...
                <div class="form-group m-b-15">
                    ...
                    <div class="UAClass">
                        ...
                        <div class="form-group m-b-15 pum_angsuran" >
                            <label class="col-lg-4 col-form-label">Rencana Pembayaran {{$r->termin}}</label>
                            <div class="input-group col-lg-5">
                 ...
                 <div class="m-b-15">
                    <a onclick="history.back()" class="btn btn-orange btn-block btn-lg">Kembali</a>
                     <button type="submit"  id="submit" onclick="return confirm('Apakah Anda Yakin Update MOU ini?')" class="btn btn-success btn-block btn-lg">Update MOU</button>
                 </div>
				 </form>
         </div>   
