...
<h1 class="page-header">Pengajuan KPR<small> Add new...</small></h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
				...
				<form enctype="multipart/form-data" method="POST" action="{{ url("kpr")}}">
                    @csrf  
                    <input type="hidden" name="id_spr" value="{{$id}}">
						...
						<div class="form-group row m-l-15">
                            <label class="col-form-label col-md-3">Kekurangan Konsumen</label>
                            <div class="col-md-4"> 
                                <input type="text" class="form-control text-right" value="{{ number_format($rx->gross_rev_kpr) }}" readonly>
                       ...
                       <div class="form-group row m-l-15">
						...
						<div class="form-group row m-l-15">
                            ...
                            <div class="col-md-4"> 
                                <input type="text" id="nominal_pengajuan" name="nominal_pengajuan" class="form-control rupiah text-right" required>                                
                            </div>
                        </div>
                       ...
                       <div class="form-group row m-l-15">
						...
						<div class="form-group row m-l-15">
                            ...
                            <div class="col-md-4"> 
                                <div class="input-group" id="daterange-singledate">
                                    <input type="text" name="tanggal_sp3k" id="datepicker-default2" class="form-control" placeholder="Pilih Tanggal" />
                                    <span class="input-group-btn">
                                        <i class="fa fa-calendar-alt text-info"></i>
                                    </span>
                                </div>      
						...
						<div class="form-group row m-l-15">
                            ...
                            <div class="col-md-4"> 
                                <input type="text" name="nominal_sp3k" value="0" class="form-control rupiah text-right">                                
                            </div>
                        </div> 
                       ...
                       <div class="form-group row m-l-15">
                            ...
                            <div class="col-md-4"> 
                                <textarea name="keterangan_sp3k"  class="form-control" rows="3" placeholder="Keterangan"></textarea> 
                            </div>
                        </div> 
                        ...
                        <div class="col-md-6 "> 
                            <div class="text-right"> 
                                <button type="submit" onclick="return confirm('Apakah Anda Yakin?')"  class="btn btn-primary"><i class="fa fa-paper-plane ml-2"></i> Save </button>
