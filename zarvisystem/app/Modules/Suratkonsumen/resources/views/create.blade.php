        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url('/suratkonsumen') }}">
						...
						<div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="kode"  class="form-control" placeholder="Nomor">
