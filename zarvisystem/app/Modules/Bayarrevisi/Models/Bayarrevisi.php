<?php
namespace App\Modules\Bayarrevisi\Models;
 ...
 */
class Bayarrevisi extends Model {
    ...
    public function dataall(){ 
      ...
      ->select(db::raw("spk_proyek.*,mrab_proyek.judul, subkon.nama as nama_subkon, 
	...
	public function detailnya($id){
		...
		$listuser = $db->select("select a.kode,a.tanggal,a.gross_total,f.judul,
								...
								from spk_proyek a
								left join mrab_proyek f on a.id_mrabp = f.id
