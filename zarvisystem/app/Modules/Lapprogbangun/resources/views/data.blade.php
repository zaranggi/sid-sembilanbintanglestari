...
@section('content')
    ...
    <h1 class="page-header">Progres Pembangunan  <small>Unit </small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">@foreach($perumahan as $p)
												{{ $p->nama }}
											@endforeach</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-center text-nowrap">{{ $r->nama_kav }}
                                ...
                                <td class="text-center text-nowrap">
									<a href="{{ route('lapprogbangun.edit', $r->id_prog) }}" class="dropdown-item  ">
										<i class="fa fa-eye text-lime"></i> View
									</a>
                                </td>
                            </tr>
                            @php $no++; @endphp
