...
<h1 class="page-header">Update Progress <small>Pembangunan Rumah...</small></h1>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $x)
							...
							<tr class="font-weight-bold text-info">
                                ...
                                <td class="text-left text-nowrap">Pembangunan Unit</td>
                                ...
                                <td class="text-center text-nowrap text-sm">  {{ App\Helpers\Tanggal::indonesian_date($x->updated_at) }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Laporan Progres Bangunan</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url("progbangun/simpan")}}">
                        @csrf
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-9">
                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                                <input type="file" name="photo2"  class="form-control" placeholder="Photo 2" required>
                            </div>
                        </div>
