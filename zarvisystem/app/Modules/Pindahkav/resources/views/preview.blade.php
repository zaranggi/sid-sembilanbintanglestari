               ...
               <div class="widget-header p-t-10">
                ...
                <div class="border-top my-1"></div> 
                    ...
                    <div class="form-group row m-l-15">
                        ...
                        <div class=" col-md-6">  
                            <input type="text" id="tall" name="gross_total" value="{{ number_format($r->gross_total - $r->ppn) }}" class="form-control font-weight-bold rupiah text-right" placeholder="0" required> 
                        </div>
                    </div>  
                    <div class="form-group row m-l-15">
					...
					<div class="form-group row m-l-15">
                        ...
                        <div class=" col-md-6">  
                            <input type="text" value="{{ number_format($r->gross_total) }}" class="form-control rupiah text-right font-weight-bold" placeholder="0" required> 
                        </div>
                    </div>  
