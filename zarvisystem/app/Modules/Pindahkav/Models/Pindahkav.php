...
class Pindahkav extends Model {
	...
	public function cektagihan($id_spr,$id_jenis,$urutan)
	{
		$db = DB::connection('mysql');
		$data = $db->select("select * from tagihan where id_spr= '$id_spr' and id_jenis = '$id_jenis' and urutan = '$urutan'");  
		return $data;
	}	
