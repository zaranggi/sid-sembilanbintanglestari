						...
						<div class="invoice-header">
							...
							<div class="invoice-to">
								...
								<address class="m-t-5 m-b-5">
									...
									LB: {{ $rr->luas_bangunan }} / LT: {{ $rr->luas_tanah }}  <br/> 
								</address>
							</div>
                            ...
                            <tr> 
                                ...
                                <td class="text-center text-nowrap"> 
                                    ...
                                    <a href="#modal-dialog" id="{{ $r->id }}" class="text-successed bayar" data-toggle="modal" >
                                        <i class="fa fa-wallet text-successed"></i> Ajukan Pembayaran
                                    </a>
                                    @endif
                                </td> 
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <!-- begin panel-body -->
                <div class="panel-body"> 
					<h4 class="panel-title">Progress Pembangunan</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($spk as $r) 
							...
							<tr class="font-weight-bold text-info">
								...
								<td class="text-left font-weight-bold text-warning">
									Bobot {{ round($r->bobot,2)}}%
								</td>  
								<td class="text-left font-weight-bold text-lime">
									Progress {{ round($r->achiev,2)}}%
								</td>  
                            </tr>
								@php 
									$id_jenis= $r->id_jenis;  
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Pengajuan Pembayaran Termin</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ url("bayarsubkon/simpanbayar")}}">
                        @csrf  
                        ...
                        <div class="form-group row m-l-15">
                            <label class="col-form-label col-md-4 ">Tanggal Bayar</label>
                            <div class="col-md-5"> 
                        ...
                        <div class="form-group row m-l-15">
                            <label class="col-form-label col-md-4">Total Bayar</label>
                            <div class="col-md-5">  
