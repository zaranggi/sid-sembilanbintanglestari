...
<div class="d-sm-flex align-items-center mb-3">
        ...
        <input type="text" name="tanggal" id="tanggal" value="{{ $tanggal }}"class="btn btn-dark me-2 text-truncate text-white text-opacity-50 ms-n1" placeholder="Pilih Periode" required/>
        ...
        <div class="card border-0 mb-3 overflow-hidden bg-dark text-white">
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="mb-3 text-grey">
                        <b>{{ $r->nama }} - Tren Penjualan by KPR {{$tanggal}} </b>
                            <span class="ml-2">
                                <i class="fa fa-info-circle" data-toggle="popover" data-trigger="hover" data-title="Total Penjualan Unit" data-placement="top" data-content="Total Penjualan Unit di Tahun {{$tanggal}}."></i>
                            </span>
                        </div>
                        <hr class="bg-white-transparent-2" />        
...
<script type="text/javascript">
 $(function () {
    Highcharts.chart('container', {        
        ...
        title: {
            text: 'Penjualan Unit Periode {{$tanggal}}'
        },
        subtitle: {
