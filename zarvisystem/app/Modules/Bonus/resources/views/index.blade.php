        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Pembayaran Bonus Karyawan</h4>
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ route('bonus.create') }}" class="btn  btn-primary mb-5">
                        <i class="fas fa-lg fa-fw m-r-10 fa-plus"></i> Buat Pengajuan Bonus
                    </a>
                                ...
                                <td class="text-center">    
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('bonus/detail/'.$r->periode)}}" class="dropdown-item">
