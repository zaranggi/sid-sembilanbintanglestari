                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/munit/saveadd') }}">
                        ...
                        <div class="form-group m-b-5">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="nama"  class="form-control" placeholder="Nama Blok">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="luas_tanah"  class="form-control meter text-right" placeholder="Luas Tanah (meter persegi)">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="luas_bangunan"  class="form-control meter text-right" placeholder="Luas Bangunan (meter persegi)">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="harga"  class="form-control harga text-right" placeholder="Rp 0.00">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <label class="col-lg-4 col-form-label">Harga Jual Tanah / Kavling</label>

                            <div class="input-group col-lg-4"> 

                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>

                                <input type="text" name="hargakav"  class="form-control harga text-right" placeholder="Rp 0.00">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <label class="col-lg-4 col-form-label">Nilai Persediaan Tanah per Meter</label>

                            <div class="input-group col-lg-4"> 

                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>

                                <input type="text" name="hpp_tanah"  class="form-control harga text-right" placeholder="Rp 0.00">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <label class="col-lg-4 col-form-label">Nilai Persediaan Bangunan</label>

                            <div class="input-group col-lg-4"> 

                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>

                                <input type="text" name="hpp_bangunan"  class="form-control harga text-right" placeholder="Rp 0.00">
