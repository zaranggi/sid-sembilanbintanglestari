...
@section('content')
    ...
    <h1 class="page-header">Approval Cuti  <small> Karyawan</small></h1>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-center" >{{  App\Helpers\Tanggal::tgl_indo($r->tanggal_start) }} - {{  App\Helpers\Tanggal::tgl_indo($r->tanggal_end) }}</td>
                                <td class="text-center" >{{ App\Helpers\Tanggal::selisih_hari2($r->tanggal_start,$r->tanggal_end) }} Hari</td>
                                <td>{{ $r->keterangan }}</td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('appcuti/approve/'.$r->id) }}" data-confirm="Apakah Anda Yakin?" rel="nofollow"  class="dropdown-item">
                                                <i class="fa fa-pen-alt text-successed"></i> Approve
                                            </a>
                                            <a href="{{ url('appcuti/tolak/', $r->id) }}" data-confirm="Apakah Anda Yakin?" rel="nofollow" class="dropdown-item">
