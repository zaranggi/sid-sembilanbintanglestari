...
<h1 class="page-header">Manage Notulen<small>...</small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" class="form-horizontal" method="POST" role="form" action="{{ route('notulen.update', $data->id) }}"> 
                        @csrf
                        @method('PATCH') 
                        @if ( count( $errors ) > 0 ) 
