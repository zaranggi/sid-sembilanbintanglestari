...
class Appspkrev extends Model {
    ...
    public function dataall()
	{
        ...
        if(Auth::user()->id_jabatan == 5  OR  Auth::user()->id_jabatan == 1){
            ...
            ->select(db::raw("spk_proyek.*, properti.nama as nama_properti, mrab_proyek.judul,
								properti_kav.nama as nama_kav, properti_kav.tipe as tipe_unit"))
    ...
    public function approve($idspk){ 
        ...
        if(Auth::user()->id_jabatan == 5 ){
            ...
            $datanya = Appspkrev::findOrFail($idspk);
            $pesan = "Anda memiliki Pending Approval atas Pengajuan SPK Revisi Unit <br>
            ...
            {
                $message->subject("New Approval :: Pengajuan SPK Revisi Unit"); 
