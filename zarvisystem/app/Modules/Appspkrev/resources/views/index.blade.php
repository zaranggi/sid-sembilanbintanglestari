        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Data SPK Revisi Unit</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr> 
                                ...
                                <td class="text-nowrap">{{ $r->tipe_unit }}</td> 
                                ...
                                <td class="text-center text-nowrap">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('appspkrev/detail/'.$r->id) }}" class="dropdown-item text-lime">
                                                <i class="fa fa-search "></i> Preview
                                            </a>
                                        @if($r->status == "1")
                                    
                                            <a href="{{ url('appspkrev/approve/'. $r->id) }}" data-confirm="Apakah yakin akan Approve SPK?" rel="nofollow" class="dropdown-item text-lime">
                                                <i class="fa fa-save "></i> Approve
                                            </a>                                            
                                            <a href="{{ url('appspkrev/reject/'. $r->id) }}" data-confirm="Apakah yakin akan Reject SPK?" rel="nofollow" class="dropdown-item text-warning">
