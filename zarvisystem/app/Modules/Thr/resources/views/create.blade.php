...
<h1 class="page-header">Form <small>Pengajuan Thr </small></h1>
        ...
        <!-- begin panel -->
			...
			<div class="panel-body">
				...
				@if ( count( $errors ) > 0 ) 
					...
					<div class="row">
						...
						<div class="col-lg-6"> 
							...
							<div class="form-group row m-l-15">
								<label class="col-form-label col-md-4">Periode Thr</label>
								<div class="col-md-6"> 
                            ...
                            <table class="table table-bordered table-hover" id="listitem">
                                <thead>
                                    <tr class="bg-lime">
                                        ...
                                        <th class="col-lg-3 text-center">Total Thr</th>
                    ...
                    <div class="m-b-15">
                        <button type="submit"  id="submit" onclick="return confirm('Apakah Anda Yakin?')" class="btn btn-success btn-block btn-lg">Simpan Pengajuan THR</button>
                    </div>
                </form>  
			</div>
	</div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row m-l-15">
								<label class="col-form-label col-md-3">Total Thr</label>
								<div class="col-md-3">      
									<input type="text" name="total_thr"  value="0" style="text-align: right;" class="form-control font-weight-semibold rupiah total_thr">
...
<script type="text/javascript"> 
    $(document).ready(function(){
        ...
        $(".add-row").click(function(){
            ...
            var total_thr = $(".total_thr").val();
            var total_thrv = tandaPemisahTitik(total_thr);
            
            var total = intVal(total_thr)
            var totalv = tandaPemisahTitik(intVal(total_thr))
            var markup = "<tr> <td class='text-left'> <input type='hidden' name='id_user[]' value='" + id_user + "'>" + nama_user + "</td> <td class='text-right'><input type='hidden' name='total_thr[]' value='" + total_thr + "'>" + total_thrv + "</td> <td><a href='javascript:void(0);' class='delete-row'><i class='fa fa-trash-alt text-danger'></i></a></td></tr>";
        ...
        $.ajax({
            ...
            error: function(){
                ...
                Swal.fire({
                    ...
                    window.location = "{{url('thr/create')}}";
                });
