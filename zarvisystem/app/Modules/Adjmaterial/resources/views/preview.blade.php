...
<h1 class="page-header">Preview <small>Adjustment Material </small></h1>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover width-full" id="listitem">
                                <thead>
                                    <tr class="bg-lime">
                                        <th class="col-lg-2 text-center">PLU</th>
                                        <th class="col-lg-4 text-center">Nama Material</th>
                                        <th class="col-lg-2 text-center">Satuan</th>
                                        <th class="col-lg-2 text-center">Harga</th>
                                ...
                                <tbody> 
									...
									<tr>
										...
										<td class="text-center">{{ number_format($r->gross) }}</td>
									</tr>
									@endforeach
