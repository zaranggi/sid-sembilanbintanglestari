...
@section('content')
    ...
    <h1 class="page-header">Adjustment  <small>Material </small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Ajdustment</h4>
                    
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body">
                    <a href="{{ route('adjmaterial.create') }}" class="btn  btn-primary mb-5">
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-center">ADJ-0{{ $r->docno }}</td>  
                               ...
                               <td class="text-center text-nowrap"> 
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
											<a href="{{ url('adjmaterial/detail/'.$r->docno) }}" class="dropdown-item text-lime">
