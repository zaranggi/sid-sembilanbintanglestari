...
<h1 class="page-header">Form <small>Adjustment Material </small></h1>
        ...
        <!-- begin panel -->
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Adjustment Material </h4>
			...
			<div class="panel-body">
				...
				@if ( count( $errors ) > 0 ) 
					...
					<div class="row">
						<div class="col-lg-6"> 
							<div class="form-group row m-l-15">
								...
								<div class="col-md-6"> 
										<input type="text" value="ADJ-0{{$docno}}" name="docno" class="form-control" placeholder="Nomor Dokumen" readonly/>
								</div>
							</div>  
                    ...
                    <button type="button" class="btn bg-warning m-l-15" data-toggle="modal" data-target="#modal_theme_primary">
                        <i class="fa fa-plus ml-2"></i> Input Data 
                    </button>
                     <br/>
                     <br/>
                    <div class="panel pagination-grey clearfix m-b-0">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover width-full" id="listitem">
                                <thead>
                                    <tr class="bg-lime">
                                        <th class="col-lg-1 text-center">PLU</th>
                                        <th class="col-lg-4 text-center">Nama Material</th>
                                        <th class="col-lg-1 text-center">Satuan</th>
                                        <th class="col-lg-2 text-center">Volume</th> 
                    ...
                    <div class="m-b-15">
                        <button type="submit"  id="submit" onclick="return confirm('Apakah Anda Yakin?')" class="btn btn-success btn-block btn-lg">Ajukan Adjustment Material</button>
                    </div>
                </form>  
			</div>
	</div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h4 class="modal-title">Adjustment Material</h4>
                        ...
                        <div class="modal-body">
							...
							<div class="form-group row m-l-15">
								...
								<div class="col-md-8">
									<select class="default-select2 form-control datanya" placeholder="Cari / Pilih Material... " name="prdcd">
										 @foreach($data as $r)
											<option value="{{$r->prdcd}}|{{$r->nama}}|{{$r->satuan}}">{{$r->prdcd}} - {{$r->nama}}</option>
										 @endforeach 
									</select>								
								</div>
							</div>
                            ...
                            <div class="form-group row m-l-15">
								...
								<div class="col-md-3">      
									<input type="number" name="qty"  value="0" style="text-align: right;" class="form-control font-weight-semibold rupiah qtynya">
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.status == true){
                    ...
                    window.location = "{{url('adjmaterial')}}";
                });  
                }else{
                    Swal.fire({
                    title: "Pesan informasi",
            ...
            error: function(){
                ...
                Swal.fire({
                    ...
                    window.location = "{{url('adjmaterial/create')}}";
                });
