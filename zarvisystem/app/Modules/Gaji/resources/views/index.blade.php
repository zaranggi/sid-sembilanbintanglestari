        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Pembayaran Gaji Karyawan</h4>
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ route('gaji.create') }}" class="btn  btn-primary mb-5">
                        <i class="fas fa-lg fa-fw m-r-10 fa-plus"></i> Buat Pengajuan Gaji
                    </a>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-left text-nowrap">{{  $r->status }}</td>   
                                ...
                                <td class="text-center">    
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('gaji/detail/'.$r->periode)}}" class="dropdown-item">
