...
@foreach($konsumen as $rr)
    ...
    <h1 class="page-header">Data Pembayaran <small> PPn</small></h1>
                ...
                <div class="panel-body">
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr> 
                                <td class="text-center text-nowrap">{{ $r->jenis }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Pembayaran PPn </h4>
					<button type="button" class="close text-danger" data-dismiss="modal" aria-hidden="true">x</button>
                </div>
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ url("ppn/simpanbayar")}}">
                        @csrf  
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($his as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{  url('image/buktibayar/'. $r->photo) }}" target = "_blank"> <i class="fa fa-money-bill-wave"></i>  </a></td>                                
                            </tr>
