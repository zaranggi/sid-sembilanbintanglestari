                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('appmrabr/view/'.$r->id) }}" target="_blank" class="dropdown-item">
                                                <i class="fa fa-eye text-info"></i> View RAB
                                            </a>
                                            @if($r->status == 1)
                                            <a href="{{ url('appmrabr/approve/'.$r->id) }}" data-confirm="Apakah yakin akan Approve RAB?" rel="nofollow" class="dropdown-item">
                                                <i class="fa fa-save text-info"></i> Approve
                                            </a>
                                            
                                            <a href="{{ url('appmrabr/reject/'.$r->id) }}" data-confirm="Apakah yakin akan Reject RAB?" rel="nofollow" class="dropdown-item">
