    ...
    <div class="col-lg-12">
       <div class="widget"> 
                    <div class="widget-header p-t-10">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="m-l-15 m-t-10 text-info">Form Saldo Awal</h4>   
                            </div> 
                        </div>
                    </div> 
           <!-- begin panel --> 
                <form id="simpanjurnal" method="POST" action="javascript:void(0)"> 
                    ...
                    <div class="form-group row m-l-15">
                        <label class="col-form-label col-md-2 ">Periode Saldo Awal</label>
                        <div class="col-md-3"> 
                    ...
                    <div class="m-b-15">
                        <button type="submit" id="submit" onclick="return confirm('Apakah Anda Yakin?')" class="btn btn-lime btn-block btn-lg">Simpan Saldo Awal</button>
                    </div>
                </form>  
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h4 class="modal-title">Akun Perkiraan</h4>
