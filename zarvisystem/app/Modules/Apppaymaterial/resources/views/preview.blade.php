...
<h1 class="page-header">Form <small>Penerimaan Material </small></h1>
        ...
        <!-- begin panel -->
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Data Penerimaan Material </h4>
								...
								@php $no = 1; $t = 0; @endphp
									@foreach($data as $r)
										<tr>
											...
											<td class="text-right">{{ number_format($r->qty_real)}}</td>
											<td class="text-right" >{{number_format($r->price_real)}}</td>
											<td class="text-right">{{number_format($r->gross_real)}}</td>
											<td class="text-center">{{$r->pembayaran}}</td>
										</tr>
										@php $t += $r->gross_real; $no++; @endphp
									@endforeach
