...
@section('content')
    ...
    <h1 class="page-header">Approval  <small>Pembayaran Material </small></h1>
                                ...
                                <td class="text-center text-nowrap">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('apppaymaterial/detail/'.$r->docno.'/'.$r->cara_bayar) }}" target="_blank" class="dropdown-item text-lime">
                                                <i class="fa fa-search "></i> Preview
                                            </a>
                                        @if($r->status == "1")
                                    
                                            <a href="{{ url('apppaymaterial/approve/'.$r->docno.'/'.$r->cara_bayar) }}" data-confirm="Apakah yakin akan Approve PO?" rel="nofollow" class="dropdown-item text-lime">
