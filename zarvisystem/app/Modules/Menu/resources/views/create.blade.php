...
<h1 class="page-header">Manage Menu <small>Add new menu...</small></h1>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/menu') }}">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="name_menu"  class="form-control" placeholder="Name Menu">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="link"  class="form-control" placeholder="Link Address">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="icon"  class="form-control" placeholder="fa-icon">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                <select name="id_main" data-placeholder="Select a Main Menu" class="form-control select2 select-icons" data-fouc>
