                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap  text-nowrap" >{{  strtoupper($r->keterangan) }}</td>
                                ...
                                <td class="text-nowrap  text-center">
                                    ...
                                    @else 
                                            <span class="text-info">Maaf Blok Sudah Terjual, Booking tidak bisa dibatalkan </span>
									@endif
                                </td> 
                            </tr>
                            @php 
