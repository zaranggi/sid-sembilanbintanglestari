...
namespace App\Modules\Paysubkon\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Routing\Controller;

use App\Modules\Paysubkon\Models\Paysubkon; 
use App\Modules\Paysubkon\Models\Terminapp; 
...
class PaysubkonController extends Controller
{
     /**
    ...
    public function __construct(Paysubkon $data)
    {
        $this->data = $data;
    }
    ...
    public function index()
    {
        ...
        return view("Paysubkon::index", ['data' => $data, 'bank_pt' => $bank_pt, 'bank' => $bank]); 
    }
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $menu = Paysubkon::findOrFail($id_termin);
			if(($menu->nilai - $gross) == 0){
				...
				//=================Insert Mtran ===================================
					...
					$mt->rtype			= "AP";
					$mt->id_properti 	=  $data->id_properti;
					$mt->id_kav 	    =  $data->id_kav;
					...
					$data_kon = Trxkonsumen::where("status_spr","=","1")
											->where("id_properti","=",$data->id_properti)
											->where("kav","=",$data->id_kav)
											->orderby("id","DESC")
											->take(1)
											->get();
