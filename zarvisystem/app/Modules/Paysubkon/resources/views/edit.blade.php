...
<h1 class="page-header">Pembayaran <small>Booking Fee / Tanda Jadi...</small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('booking.update', $data->id) }}">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" value="" name="name_menu"  class="form-control" placeholder="Name Menu">
