                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-center">    
                                    ...
                                    @else
                                        <a href="{{ url('booking/cetak/'.$r->id."/".$r->urutan) }}" class="text-lime font-weight-bold" target="_blank">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ url("booking/simpanbayar")}}">
                        @csrf  
