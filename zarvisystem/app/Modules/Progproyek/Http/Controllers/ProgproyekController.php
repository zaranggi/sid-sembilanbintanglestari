...
namespace App\Modules\Progproyek\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Routing\Controller;

use App\Modules\Progproyek\Models\Progproyek;
...
use DB;
class ProgproyekController extends Controller
{
    public function __construct(Progproyek $data)
    {
        $this->data = $data;
    }
    /**
    ...
    public function index()
    {
        ...
        return view('Progproyek::index', ['data' => $data]);
    }
    ...
    public function edit($id)
    {
		...
		return view("progproyek::edit",['data' => $data ]);
    ...
    {  
        ...
        if ($validator->fails()) {
            return Redirect::to('progproyek/'.$request->input("id").'/edit')->withErrors($validator)->withInput();
        }
        else
        {
			
			$data = Progproyek::findOrFail($request->input("id")); 
            ...
            return redirect('progproyek/'.$request->input("id").'/edit');
