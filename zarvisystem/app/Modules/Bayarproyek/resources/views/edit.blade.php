...
@foreach($detailnya as $rr)
    ...
    <h1 class="page-header">Pengajuan Pembayaran <small>Termin Proyek </small></h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ url("bayarproyek/simpanbayar")}}">
                        @csrf  
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn width-100 btn-primary">Simpan</button>
