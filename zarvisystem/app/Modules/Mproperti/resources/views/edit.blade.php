        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('mproperti.update', $data->id) }}">
                        ...
                        <div class="form-group m-b-5">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" value="{{$data->nama}}" name="nama"  class="form-control" placeholder="Nama Properti/Perumahan">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                                <input type="text" value="{{$data->alamatkantor}}" name="alamatkantor" class="form-control" placeholder="Alamat">
                                <strong style="color:red">{{ $errors->first('alamat') }}</strong>
                            </div>
                        </div>  
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                                <input type="text" value="{{$data->luas_tanah}}" name="luas_tanah"  class="form-control nomor text-right" placeholder="Luas Tanah (meter persegi)">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-6">  
                                <select name="bank[]" class="form-control multiple-select2" multiple="multiple" data-fouc>
                                    ...
                                    <?php $cek_level = preg_match( '/#'.$r->id.'#/' ,$data->bank ) ?>
                                        ...
                                        <option value="#{{ $r->id }}#" selected> {{ $r->nama }} - {{ $r->atas_nama }} : {{ $r->nomor_rekening }}</option>
