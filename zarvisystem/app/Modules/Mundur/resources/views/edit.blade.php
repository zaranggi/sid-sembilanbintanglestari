         ...
         <div class="col-lg-7">
            ...
            <div class="widget"> 
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group row m-l-15">
                        <label class="col-form-label col-lg-3 font-weight-bold text-lime">Pengembalian PT</label>
                        <div class="col-lg-4"> 
                            <input type="text" id="kekurangan" value="{{$r->pengembalian}}"  class="form-control rupiah text-right" readonly> 
                        </div>
                    </div>
