...
<h1 class="page-header">Manage Daftar Kontak WA <small>Edit </small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('wacontact.update', $menu->id) }}">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                ...
                                <input type="text" name="kontak" value="{{ $menu->phone}}" class="form-control" placeholder="Kontak">
