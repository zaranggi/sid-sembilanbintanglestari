                    ...
                    <table class="table table-bordered table-hover ">
                        <thead>
                         ...
                         <tbody>
							...
							<tr class="text-nowrap"> 
                                <td>Kekurangan KPR Konsumen</td>    
                                <td class="tagihan6 text-right rupiah">{{ number_format($r->tagihan7)}}</td>  
                                <td class="bayar6 text-right rupiah">{{ number_format($r->bayar7)}}</td>  
                                <td class="kekurangan6 text-right rupiah">{{ number_format($r->tagihan7 - $r->bayar7)}}</td>  
                            </tr> 
                        </tbody>
                    </table>
