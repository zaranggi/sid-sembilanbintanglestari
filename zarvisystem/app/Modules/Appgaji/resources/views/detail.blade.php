        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Pengajuan Gaji Karyawan</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-right text-nowrap">Rp {{number_format($r->gaji_pokok)}}</td> 
                                <td class="text-right text-nowrap">Rp {{number_format($r->tunjangan1)}}</td> 
                                <td class="text-right text-nowrap">Rp {{number_format($r->lembur)}}</td> 
                                <td class="text-right  text-nowrap">Rp {{number_format($r->tunjangan2)}}</td> 
                                <td class="text-right text-nowrap">Rp {{number_format($r->potongan1)}}</td>
                                <td class="text-right text-nowrap">Rp {{number_format($r->bpjs_kesehatan)}}</td>
                                <td class="text-right text-nowrap">Rp {{number_format($r->bpjs_tk)}}</td> 
                        ...
                        @endforeach 
                            ...
                            <tfoot>
                                <tr class="font-weight-bold bg-success text-white">
                                    <td colspan="9" class="text-center text-nowrap">Grand Total</td>
