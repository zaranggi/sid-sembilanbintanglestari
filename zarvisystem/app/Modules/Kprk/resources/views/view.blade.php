...
@foreach($konsumen as $rr)
    ...
    <h1 class="page-header">Data Pembayaran <small> Kekurangan KPR </small></h1>
                        ...
                        <table id="data-table"  class="table table-bordered table-hover width-full">
                            <thead>
                                <tr class="text-center"> 
                                    ...
                                    <th class="text-nowrap">Kekurangan KPR</th>
	...
	<div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                <!-- begin panel-heading -->
                <div class="panel-heading">
                    <h4 class="panel-title">History Pembayaran  Kekurangan KPR</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        @foreach($his as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap" ><h6><a href="#"> {{ $r->nama_rekening_pengirim  }}</a>  <span class="d-block font-size-sm text-muted">{{ $r->bank_pengirim ." - ". $r->norek_pengirim}}</span>  </h6> </td>
                                <td class="text-right" >{{  number_format($r->jumlah) }}</td>
                                <td class="text-center">
                                    <a href="{{ url('kprk/cetak/'.$r->kode) }}" class="text-lime font-weight-bold" target="_blank">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ url('kprk/simpanbayar')}}">
                        @csrf  
