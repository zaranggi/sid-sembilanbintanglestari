        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/mrab') }}">
                        ...
                        @foreach($spk as $r)
                                ...
                                <div class="row">
                                <div class="col-lg-3">  
                                <input type="hidden" name="jenis_spk_{{$r->id}}"  value="{{$r->id}}" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" name="bobot_{{$r->id}}" maxlength="3" style="text-align: center;" placeholder="Bobot" class="form-control rupiah" required>
                                ...
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="qty_{{$r->id}}" name="qty_{{$r->id}}" style="text-align: center;" placeholder="Volume" class="form-control rupiah" required>
                                ...
                                <div class="col-lg-2">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="price_{{$r->id}}" name="price_{{$r->id}}" style="text-align: center;" placeholder="Harga Satuan" class="form-control rupiah" required>
                                ...
                                <div class="col-lg-2">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                            <input type="text" id="gross gross_{{$r->id}}" name="gross_{{$r->id}}"  placeholder="Jumlah (Rp)" style="text-align: right;background-color: #fff;opacity: 1; " class="form-control rupiah font-weight-bold text-primary-600 font-size-lg" readonly>                                                
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group-feedback form-group-feedback-left">                                             
                                            <input type="text" name="total"  id="total"  class="form-control text-center font-weight-bold text-primary-600 font-size-lg" readonly>                                            
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text"  id="t1_{{$r->id}}" name="t1_{{$r->id}}" style="text-align: center;" placeholder="T-1" class="form-control nomor" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="t2_{{$r->id}}" name="t2_{{$r->id}}" style="text-align: center;" placeholder="T-2" class="form-control nomor" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text"  id="t3_{{$r->id}}" name="t3_{{$r->id}}" style="text-align: center;" placeholder="T-3" class="form-control nomor" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="t4_{{$r->id}}" name="t4_{{$r->id}}" style="text-align: center;" placeholder="T-4" class="form-control nomor" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="t5_{{$r->id}}" name="t5_{{$r->id}}" style="text-align: center;" placeholder="T-5" class="form-control nomor" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text"  id="retensi_{{$r->id}}" name="retensi_{{$r->id}}" value="5" style="text-align: center;" placeholder="Retensi" class="form-control nomor" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="termin_{{$r->id}}"  placeholder="0%" style="text-align: center;background-color: #fff;opacity: 1; " class="form-control rupiah font-weight-bold text-primary-600 font-size-lg" >                                                
                                            </div>
                                        </div>
                                    </div>
                                </div> 
...
<script type="text/javascript">  
 $(document).ready(function() {
    ...
    @foreach($spk as $r)
    $("#qty_{{$r->id}}").keyup(function() {
        var qty  = $(this).val();
        var price  = $("#price_{{$r->id}}").val();
        var h = intVal(qty) * intVal(price);
        $('input[name=gross_{{$r->id}}]').val(h);
        calculateTotal();
        
    });
    
    $("#price_{{$r->id}}").keyup(function() {
        var price  = $(this).val();
        var qty  = $("#qty_{{$r->id}}").val();
        var h = intVal(qty) * intVal(price);
        $('input[name=gross_{{$r->id}}]').val(h);
        calculateTotal();
    });
    ...
    $("#t1_{{$r->id}}").keyup(function() {
        ...
        var d  = $('#t4_{{$r->id}}').val(); 
        var e  = $('#t5_{{$r->id}}').val(); 
        var f  = $('#retensi_{{$r->id}}').val(); 
        var to = intVal(a) +intVal(b) +intVal(c) +intVal(d) +intVal(e) +intVal(f) ;
        $('#termin_{{$r->id}}').val(to);
        
    });
    
    $("#t2_{{$r->id}}").keyup(function() {
