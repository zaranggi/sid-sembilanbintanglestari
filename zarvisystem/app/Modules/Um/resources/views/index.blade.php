...
@section('content')
            ...
            <h1 class="page-header"> List Tagihan Uang Muka  <small>Konsumen</small></h1>
                ...
                <div class="row">
						...
						<div class="col-xl-4 col-md-6">
							<div class="widget widget-stats bg-blue">
								...
								<div class="stats-link">
									<a href="{{ url('um/listall/'.$r->id) }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
								</div>
							</div>
						</div>
						@endforeach
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="panel p-20">
                            ...
                            <form class="form-input-flat" method="POST" action="{{url('um/tagihan')}}">
                                {{ csrf_field() }}
