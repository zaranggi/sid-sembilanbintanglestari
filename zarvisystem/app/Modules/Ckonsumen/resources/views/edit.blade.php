...
<h1 class="page-header">Manage Calon Konsumen <small>Update new...</small></h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="widget"> 
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('ckonsumen.update', $data->id) }}">
                    @csrf
                    @method('PATCH')
        ...
        <div class="col-lg-6">
            <div class="widget"> 
                ...
                <div class="form-horizontal">  
                    ...
                    <div class="form-group m-b-5">
                        <label class="col-lg- col-form-label">Nama Kantor/ Usaha</label>
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
            ...
            <div class="widget"> 
                ...
                <div class="form-horizontal">  
                    ...
                    <div class="form-group m-b-5">
                        ...
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                            <input type="text" value="{{ $data->gaji }}" name="gaji_pasangan"  class="form-control rupiah">
                            <strong style="color:red">{{ $errors->first('gaji') }}</strong>
                        </div>
                    </div>  
                    <div class="form-group m-b-5">
