...
<h1 class="page-header">Laporan Neraca <small>Per Periode...</small></h1>
         ...
         <div class="col-lg-6">
            ...
            <div class="widget">  
                <div class="my-2"></div> 
                    ...
                    @endif 
               <form class="form-horizontal" role="form" method="POST" action="{{ url('/neraca/preview') }}">
                    ...
                    <div class="form-group m-b-5">
                        ...
                        <div class="input-group col-lg-9"> 
                            <div class="row row-space-10">
                                <div class="col-12">
                                    <input type="text" name="periode" class="form-control"  id="datetimepicker3" placeholder="Periode" required />
                                </div>
