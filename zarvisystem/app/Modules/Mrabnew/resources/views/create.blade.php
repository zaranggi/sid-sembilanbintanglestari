...
<h1 class="page-header">RAB  <small>Pembanguanan Rumah ...</small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/mrabnew') }}">
                        ...
                        <div class="form-group row m-l-15">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="judul"  class="form-control" placeholder="Nama Rab" required>
                        ...
                        <div class="mb-2"></div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <label class="col-lg-12 col-form-label">*) Termin Pembayaran (% dalam persen)</label>
                                </div>
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
