...
<h1 class="page-header">Manage Surat Keluar<small>...</small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url('/suratout') }}">
                        ...
                        <div class="form-group m-b-10">
                            ...
                            <div class="input-group col-lg-4"> 
                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                                <input type="text" name="pengirim"  class="form-control" placeholder="">
