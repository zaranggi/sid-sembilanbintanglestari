        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Pengajuan Marketing Fee</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        <table id="data-table"  class="table table-bordered table-hover col-lg-6">
                            <thead>
                                <tr class="text-center"> 
                                    ...
                                    <th class="col-lg-3 text-center">Nama Marketing</th>
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-right text-nowrap">Rp {{number_format($r->total_fee)}}</td> 
                        ...
                        @endforeach 
                            ...
                            <tfoot>
                                <tr class="font-weight-bold bg-success text-white">
                                    <td colspan="5" class="text-center text-nowrap">Grand Total</td>
