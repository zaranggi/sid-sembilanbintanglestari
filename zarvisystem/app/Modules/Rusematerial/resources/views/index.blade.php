...
<h1 class="page-header">List Pemakaian Material<small>Per Periode...</small></h1>
         ...
         <div class="col-lg-6">
            ...
            <div class="widget">  
                <div class="my-2"></div> 
                    ...
                    @endif 
               <form class="form-horizontal" role="form" method="POST" action="{{ url('/rusematerial/listall') }}">
