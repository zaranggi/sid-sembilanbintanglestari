				...
				@if ( count( $errors ) > 0 ) 
					...
					<div class="row">
						...
						<div class="form-group row m-l-15">
								<label class="col-form-label col-md-4">Perumahan</label>
								<div class="col-md-6"> 
									<select name="id_properti" class="default-select2 form-control" placeholder="Pilih Perumahan" required >
                                        <option>-- Pilih --</option> 
                            ...
                            <div class="form-group row m-l-15">
								...
								<div class="col-md-6"> 
									<select id="rekanan" name="dari" class="default-select2 form-control" placeholder="Pilih Vendor" required >
                                        <option>-- Pilih --</option> 
							...
							<div class="form-group row m-l-15">
								...
								<div class="col-md-6"> 
										<input type="text" value="PO-0{{$docno}}" name="docno" class="form-control" placeholder="Nomor Dokumen" readonly/>
								</div>
							</div>  
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover width-full" id="listitem">
                                <thead>
                                    <tr class="bg-lime">
                                        <th class="col-1 text-center">PLU</th>
                                        <th class="col-4 text-center">Nama Material</th>
                                        <th class="col-1 text-center">Satuan</th>
                                        <th class="col-2 text-center">Volume</th>
                                        <th class="col-1 text-center">Cara Bayar</th>
                    ...
                    <div class="m-b-15">
                        <button type="submit"  id="submit" onclick="return confirm('Apakah Anda Yakin?')" class="btn btn-success btn-block btn-lg">Ajukan PO Material</button>
                    </div>
                </form>  
			</div>
	</div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h4 class="modal-title">PO Material</h4>
                        ...
                        <div class="modal-body">
							...
							<div class="form-group row m-l-15">
								...
								<div class="col-md-8">
									<select id="prodmast" class="default-select2 form-control datanya" placeholder="Cari / Pilih Material... " name="prdcd">
							...
							<div class="form-group row m-l-15">
								<label class="col-form-label col-md-3">Pembelian</label>
								<div class="col-md-3">
									<select class="default-select2 form-control pembayaran">
...
<script type="text/javascript"> 
    $(document).ready(function(){
        ...
        $(".add-row").click(function(){
            ...
            var markup = "<tr><td class='text-center'><input type='hidden' name='prdcd[]' value='" + plu + "'>" + plu + "</td><td>" + deskripsi + "</td><td class='text-center'>" + satuan + "</td><td class='text-center'><input type='hidden' name='qty[]' value='" + qtynya + "'>" + qtyv + "</td><td class='text-center'>" + pembayaran + "<input type='hidden' name='pembayaran[]' value='" + pembayaran + "'></td><td><a href='javascript:void(0);' class='delete-row'><i class='fa fa-trash-alt text-danger'></i></a></td></tr>";
	...
	$('#rekanan').change(function(){
		$("#listitem tbody").empty();
			...
			if(id){
				$.ajax({
					type:"GET",
					url:"{{url('pomaterial/listprodmast')}}/"+id,
					success:function(res){
						$("#prodmast").empty(); 
						if(res){
							
							$("#prodmast").append('<option>Pilih Material</option>');
							$.each(res,function(key,value){

								$("#prodmast").append('<option value="'+value['prdcd']+'|'+value['nama']+'|'+value['satuan']+'" data-icon="location3">'+value['prdcd']+'::'+value['nama']+' Satuan : '+value['satuan']+'</option>');
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.status == true){
                    ...
                    window.location = "{{url('pomaterial')}}";
                });  
                }else{
                    Swal.fire({
                    title: "Pesan informasi",
