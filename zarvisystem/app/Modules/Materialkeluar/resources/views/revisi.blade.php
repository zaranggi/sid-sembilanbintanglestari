        ...
        <!-- begin panel -->
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Material Keluar Pengerjaan Revisi Unit</h4>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group row m-l-15">
								...
								<div class="col-md-8"> 
									<select id="properti" name="id_spk" class="default-select2 form-control" placeholder="Pilih Proyek" required >
										<option>-- Pilih Proyek--</option>       
										@foreach($listproyek as $r)                                
											<option value="{{ $r->id }}">{{ $r->nama_properti }} :: {{ $r->judul }} - {{ $r->nama_kav }} Tipe: {{ $r->tipe_unit }}</option>      
										@endforeach
									</select>
								</div>
							</div> 
							<div class="form-group row m-l-15">
								...
								<div class="col-md-6"> 
										<input type="text" name="docno" class="form-control" placeholder="Nomor Dokumen" required/>
								</div>
							</div>   
...
$(document).ready(function(){
    $("#simpanmaterial").submit(function(){  
        ...
        $.ajax({
            url:"{{ url('materialkeluar/revisi/simpan') }}",
            method:"POST",
            ...
            success:function(data){
                ...
                if(data.status == true){
                    ...
                    window.location = "{{url('materialkeluar/revisi')}}";
                });  
                }else{
                    Swal.fire({
                    title: "Pesan informasi",
