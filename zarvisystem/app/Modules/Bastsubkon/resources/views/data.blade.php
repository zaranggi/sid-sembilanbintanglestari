        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">BAST Subkon</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        <table id="data-table"  class="table table-bordered table-hover width-full">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th class="text-nowrap">SPK</th>
                                    <th class="text-nowrap" >Nama Subkon</th>
                                    <th class="text-nowrap" >Unit/Tipe</th>
                                    <th class="text-nowrap" >Tgl Akhir SPK</th>
                                    <th class="text-nowrap" >Tgl Bast</th>
                                    <th class="text-nowrap" >File BAST</th>
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td  class="text-left text-nowrap">{{  $r->nama_subkon }}</td>
                                <td  class="text-center text-nowrap">{{  $r->nama_kav }} / {{  $r->tipe_kav }}</td>
                                <td  class="text-center text-nowrap">{{  App\Helpers\Tanggal::tgl_indo($r->tanggal_bast) }}</td>
                                <td  class="text-center text-nowrap">{{  App\Helpers\Tanggal::tgl_indo($r->created_at) }}</td>
                                ...
                                <td class="text-center">
									@if($r->created_at == "")
										<a href="#modal-dialog" id="{{ $r->id_spk }}" class="text-successed bast" data-toggle="modal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  method="POST" action="{{ url('bastsubkon/simpan')}}" enctype="multipart/form-data">
                        @csrf
