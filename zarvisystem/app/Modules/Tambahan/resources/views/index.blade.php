...
@section('content')
            ...
            <h1 class="page-header"> List Tagihan Tambahan   <small>Tanah dan Bangunan</small></h1>
                ...
                <div class="row">
						...
						<div class="col-xl-4 col-md-6">
							<div class="widget widget-stats bg-blue">
								...
								<div class="stats-link">
									<a href="{{ url('tambahan/listall/'.$r->id) }}">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
								</div>
							</div>
						</div>
						@endforeach
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="panel p-20">
                            ...
                            <form class="form-input-flat" method="POST" action="{{url('tambahan/tagihan')}}">
                                {{ csrf_field() }}
