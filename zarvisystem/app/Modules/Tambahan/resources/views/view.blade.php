...
@foreach($konsumen as $rr)
    ...
    <h1 class="page-header">Data Pembayaran <small> Penambahan Tanah/Bangunan</small></h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                <!-- begin panel-heading -->
                <div class="panel-heading">
                    <h4 class="panel-title">Tambahan Tanah / Bangunan</h4>
                        ...
                        <table id="data-table"  class="table table-bordered table-hover width-full"">
                            <thead>
                                <tr class="text-center">  
                                    <th class="text-nowrap">Tambahan</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Pembayaran Tambahan Tanah / Bangunan </h4>
					<button type="button" class="close text-danger" data-dismiss="modal" aria-hidden="true">x</button>
                </div>
                <div class="modal-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ url("tambahan/simpanbayar")}}">
                        @csrf  
