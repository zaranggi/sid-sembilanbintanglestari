...
<h1 class="page-header">SPK Revisi Unit <small>add new...</small></h1>
...
<div class="section-container section-with-top-border p-b-5">  
    ...
    @endif
    <form id="spk" enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url("spkrevisi")}}">
                ...
                <div class="form-group row m-l-15">
                    ...
                    <div class="col-md-8"> 
                        <select name="jenis" id="jenis_spk" class="default-select2 form-control" required >
                            <option>-- Pilih RAB Proyek --</option>       
