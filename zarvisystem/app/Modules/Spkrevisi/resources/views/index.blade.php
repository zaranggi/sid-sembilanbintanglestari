...
@section('content')
    ...
    <h1 class="page-header"> SPK <small> Revisi Unit </small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <a href="{{ route('spkrevisi.create') }}" class="btn  btn-primary mb-5">
                            ...
                            <tr>
                                ...
                                <td class="text-center text-nowrap"> <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                        <a href="{{ url('spkrevisi/detail/'.$r->id) }}" class="dropdown-item text-lime">
                                            <i class="fa fa-search "></i> Preview
                                        </a>
                                        @if($r->status == "0")
                                            <a href="{{ url('spkrevisi/ajukan', $r->id) }}" data-confirm="Apakah yakin akan diajukan?" rel="nofollow" class="dropdown-item  text-lime">
