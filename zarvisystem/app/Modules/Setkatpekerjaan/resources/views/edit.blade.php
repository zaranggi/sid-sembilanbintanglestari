        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('setkatpekerjaan.update', $data->id) }}">
                        ...
                        <div class="form-group m-b-10">
                            <label class="col-lg-2 col-form-label">Nama Pekerjaan</label>
                            <div class="input-group col-lg-4"> 
                                <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                                <input type="text" value="{{ $data->nama }}" name="nama"  class="form-control" placeholder="Nama Pekerjaan">
