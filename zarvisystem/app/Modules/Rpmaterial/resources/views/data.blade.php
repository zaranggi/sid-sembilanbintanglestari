        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Pembelian Material</h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        <table id="data-table"  class="table table-bordered table-hover width-full">
                            <thead>
                                <tr class="text-center"> 
                                    ...
                                    <th class="text-nowrap">Total Pembelian</th>
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td  class="text-left text-nowrap">{{  $r->nama_vendor }}</td>
                                <td class="text-center text-nowrap">{{ $r->pembayaran }}</td>
                                <td class="text-right" >{{  number_format($r->jumlah_bayar) }}</td>
                                <td class="text-center" >{{  $r->created_by }}</td>
                                <td class="text-center">      
                                <a href="{{ url('rpmaterial/detail/'.$r->docno)}}" class="text-lime bayar">
                                                <i class="fa fa-eye"></i> 
                                            </a>
