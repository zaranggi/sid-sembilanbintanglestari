        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Approval Pengajuan Fee Marketing </h4>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
                        ...
                        <table id="data-table"  class="table table-bordered table-hover width-full">
                            <thead>
                                <tr class="text-center"> 
                                    ...
                                    <th class="text-nowrap">Total Konsumen</th> 
                        ...
                        @foreach($data as $r)
                            ...
                            <tr>
                                ...
                                <td class="text-center text-nowrap">{{  $r->tkonsumen }}</td>     
                                <td class="text-right" >Rp {{  number_format($r->total) }}</td>      
                                <td class="text-center text-nowrap">{{  $r->status }}</td>   
                                <td class="text-center" >{{  App\Helpers\Tanggal::tgl_indo($r->tgl_approve) }}</td>                       
                                <td class="text-center">    
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('marketingfee/detail/'.$r->id_fee)}}" class="dropdown-item">
                                                <i class="fa fa-eye text-successed"></i> View
                                            </a>
                                            @if($r->approve == "1")
                                    
                                            <a href="{{ url('appmarketingfee/approve/'. $r->id_fee) }}" data-confirm="Apakah yakin akan Approve SPK?" rel="nofollow" class="dropdown-item text-lime">
                                                <i class="fa fa-save "></i> Approve
                                            </a>                                            
                                            <a href="{{ url('appmarketingfee/reject/'. $r->id_fee) }}" data-confirm="Apakah yakin akan Reject SPK?" rel="nofollow" class="dropdown-item text-warning">
