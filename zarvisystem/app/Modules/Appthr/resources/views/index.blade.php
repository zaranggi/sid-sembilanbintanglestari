        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Approval Pengajuan Pembayaran Thr Karyawan</h4>
                                ...
                                <td class="text-center">    
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, 19px, 0px);">
                                            <a href="{{ url('appthr/detail/'.$r->periode)}}" class="dropdown-item">
                                                <i class="fa fa-eye text-successed"></i> View
                                            </a>
                                            @if($r->app == "1")
                                    
                                            <a href="{{ url('appthr/approve/'. $r->periode) }}" data-confirm="Apakah yakin akan Approve SPK?" rel="nofollow" class="dropdown-item text-lime">
                                                <i class="fa fa-save "></i> Approve
                                            </a>                                            
                                            <a href="{{ url('appthr/reject/'. $r->periode) }}" data-confirm="Apakah yakin akan Reject SPK?" rel="nofollow" class="dropdown-item text-warning">
