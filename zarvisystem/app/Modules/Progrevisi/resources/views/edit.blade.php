...
<h1 class="page-header">Update Progress <small>Revisi Unit ...</small></h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url('progrevisi/simpan')}}">
                        @csrf  
