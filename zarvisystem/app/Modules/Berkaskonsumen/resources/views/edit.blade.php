        ...
        <div class="col-lg-6">
            ...
            <div class="widget"> 
                <div class="widget-header p-t-10">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="m-b-5 m-t-10 text-info">Data Diri</h4>                            
                        </div> 
                    </div>
                </div>
                <div class="border-top my-1"></div> 
                <form class="form-horizontal" role="form" method="POST" action="{{ route('konsumen.update', $data->id) }}">
                    @csrf
                    @method('PATCH')
        ...
        <div class="col-lg-6">
            <div class="widget"> 
                <div class="widget-header p-t-10">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="m-b-5 m-t-10 text-info">Data Pekerjaan</h4>                            
                        </div> 
                    </div>
                </div>
                <div class="border-top my-1"></div> 
                ...
                <div class="form-horizontal">  
                    ...
                    <div class="form-group m-b-5">
                        ...
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                            <textarea name="ket_kerja"  class="form-control" rows="3" placeholder="Keterangan"> {{ $data->keterangan }}</textarea> 
        ...
        <div class="col-lg-6">
            ...
            <div class="widget"> 
                <div class="widget-header p-t-10">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="m-b-5 m-t-10 text-info">Data Pasangan</h4>                            
                        </div> 
                    </div>
                </div>
                <div class="border-top my-1"></div> 
        ...
        <div class="col-lg-6">
            ...
            <div class="widget"> 
                <div class="widget-header p-t-10">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="m-b-5 m-t-10 text-info">Data Keluarga</h4>                            
                        </div> 
                    </div>
                </div>
                <div class="border-top my-1"></div> 
    ...
    <div class="col-lg-6 offset-lg-3">
        ...
        <div class="widget"> 
            <div class="widget-header p-t-10">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="m-b-5 m-t-10 text-info">Pemberkasan Konsumen</h4>                            
                    </div> 
                </div>
            </div>
            <div class="border-top my-1"></div> 
                        ...
                        <div class="checkbox">
                            <label class="col-form-label">
                                @php 
                                        ...
                                        $x->status == 1 ? $v= "checked" : $v= ""; 
                                    
                                    
                                @endphp
                                <input name="a{{ $x->id_jenis    }}" type="checkbox" value="1"  {{ $v }}> {{ $x->nama_dokumen }}
                            </label>
                        </div>
                    </div>
                </div>  
