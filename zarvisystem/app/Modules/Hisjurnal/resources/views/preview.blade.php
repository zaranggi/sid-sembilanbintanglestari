...
<div id="loader">
    ...
    <h1 class="page-header">Data  <small>Jurnal Umum</small></h1>
                                ...
                                <tbody>
                                    ...
                                    @foreach($data as $r)
                                        <tr>
                                            ...
                                            <td class="text-lime font-weight-bold">{{  $r->keterangan }}</td>
                                            <td class="text-right">{{ number_format($r->d) }}</td>
                                            <td class="text-right">{{  number_format($r->k) }}</td>
                                            <td >{{  $r->created_by }}</td>
                                             
                                            <td class="text-center">
                                                   <button data-id="{{ $r->id }}" class="btn btn-success lihat">
    ...
    <div class="modal-dialog  modal-lg">
     ...
     <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title  panel-inverse">Data Jurnal</h4>
