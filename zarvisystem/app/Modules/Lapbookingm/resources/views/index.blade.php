...
<h1 class="page-header">Laporan <small>Booking Unit by Marketing...</small></h1>
         ...
         <div class="col-lg-6">
            ...
            <div class="widget"> 
                ...
                <div class="my-3"></div> 
                    ...
                    @endif 
               <form class="form-horizontal" role="form" method="POST" action="{{ url('/lapbookingm/preview') }}">
                    ...
                    <div class="form-group m-b-5">
                        <label class="col-lg-3 col-form-label">Marketing</label>
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-user-check  text-info"></i></span>
                            <select class="default-select2 form-control" name="id_marketing" required>
