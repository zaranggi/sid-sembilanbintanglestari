        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/mrabr') }}">
						...
						<div class="form-group row m-l-15">
							...
							<div class="col-md-3"> 
								<select name="id_kav" class="pilih form-control" placeholder="Pilih Unit"  required >
									@foreach($kav as $r)
										<option value="{{$r->id}}">{{ $r->nama_kav }} :: Tipe - {{ $r->tipe_unit }}</option>
									@endforeach
								</select>
							</div>
						</div>  						
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group-feedback form-group-feedback-left">
                                                <input type="text" id="gross" name="retensi"  style="text-align: center;" placeholder="Retensi" class="form-control nomor" required>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
