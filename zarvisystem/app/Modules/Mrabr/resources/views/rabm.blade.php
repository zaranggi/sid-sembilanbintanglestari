...
<div id="loader">
    ...
    <h1 class="page-header">RAB Material <small>Revisi Unit</small></h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">                    
					...
					<a href="{{ url('mrabr') }}" class="btn btn-warning"><i class="fa fa-redo-alt ml-2"></i> Kembali </a>
                    ...
                    <div class="panel pagination-grey clearfix m-b-0">
						...
						<div class="m-b-15">
							<button type="submit"  id="submit"  class="btn btn-success btn-block btn-lg">Simpan Rab Material</button>
						</div>
					</form>  
                </div>
            </div>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.status == true){
                    ...
                    window.location = "{{url('mrabp/rabm/'.$id)}}";
                });  
                }else{
                    Swal.fire({
                    title: "Pesan informasi",
