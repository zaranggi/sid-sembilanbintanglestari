            ...
            <div class="widget"> 
                ...
                <div class="border-top my-1"></div>    
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                            <input type="text" name="idcard"  id="idcard"  class="form-control nomor text-right" > 
                        </div>
                    </div> 
                    <div class="form-group m-b-10">
               ...
               <div class="widget-header p-t-10">
                ...
                <div class="border-top my-1"></div>  
                    ...
                    <div class="form-group m-b-15 ppnnya" style="display:none">
                        ...
                        <div class="input-group col-lg-5"> 
                            <span class="input-group-addon"><i class="fa fa-handshake text-info"></i></span>
                            <input type="text" id="ppn" name="ppn" value="0" class="form-control rupiah text-right" readonly> 
                        </div>
                    </div> 
                    <div class="form-group m-b-15">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#gross_unit').keyup(function(){ 
            ...
            {
				if(cbu == "bertahap"){
					var ppn = ( intVal(gross_unit) + intVal(tplt) + intVal(tpll) ) * 0.1;
        ...
        $('#plt').keyup(function(){ 
                ...
                { 
					...
					if(cbu == "bertahap"){
						...
						var ppn = ( intVal(tpll) + intVal(ta) + intVal(gross_unit) ) * 0.1;
        ...
        $('#pht').keyup(function(){ 
                ...
                { 
                    ...
                    var ta = plt * pht; 
					if(cbu == "bertahap"){
						var ppn = ( intVal(gross_unit) + intVal(ta) + intVal(tpll) ) * 0.1;
						$('#tall').val( intVal(tpll) + intVal(ta) + intVal(gross_unit) + intVal(ppn) ); 
						$('#ppn').val(intVal(ppn));					
						$('#takh').val( intVal(tpll) + intVal(ta) + intVal(gross_unit) + intVal(ppn) - intVal(booking)  - intVal(gross_umnya) ); 
					}else{
        ...
        $('#pll').keyup(function(){ 
                ...
                { 
                    $('#tpll').val( pll );
					if(cbu == "bertahap"){
						var ppn = ( intVal(gross_unit) + intVal(tplt) + intVal(pll) ) * 0.1;
        ...
        $('#booking').keyup(function(){ 
            ...
            var cbu = $('#cbu').val();
            if(cbu == "bertahap"){
				var ppn =  (intVal(tpll) + intVal(tplt) + intVal(gross_unit))  * 0.1;
				$('#ppn').val(intVal(ppn));
