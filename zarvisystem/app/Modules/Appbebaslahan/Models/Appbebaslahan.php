<?php
namespace App\Modules\Appbebaslahan\Models;
 ...
 */
class Appbebaslahan extends Model {
    ...
    public function listdata()
	{
        ...
        if(a.status_bebas_lahan = 0,'Pengajuan Baru',if(a.status_bebas_lahan = 1,'Disetujui','Ditolak')) as status_bebas_lahan,
    ...
    public function approve($id){
        ...
        $data = $db->table('m_bebas_lahan')
            ->where('id', "$id")
            ->update(['status_bebas_lahan' => "1"]);
