...
<h1 class="page-header">Pembebasan Lahan <small>add new...</small></h1>
...
<div class="section-container section-with-top-border p-b-5">  
    ...
    @endif
    <form id="bebaslahan" class="formku" method="POST" action="javascript:void(0)">
            ...
            <div class="widget"> 
                ...
                <div class="border-top my-1"></div> 
                    ...
                    <div class="form-group m-b-10">
                        ...
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                            <input type="text" name="ktp"  class="form-control nomor2 text-right" required> 
                        </div>
                    </div> 
                    <div class="form-group m-b-10">
                        ...
                        <div class="input-group col-lg-9"> 
                            <span class="input-group-addon"><i class="fa fa-info-circle"></i></span>
                            <input type="text" name="hp" class="form-control text-right" required> 
                        </div>
                    </div>  
               ...
               <!-- begin panel --> 
                    <div class="form-group m-b-15">
                        ...
                        <div class="input-group col-lg-5"> 
                            <div class="input-group" id="daterange-singledate">
                                <input type="text" name="tanggal" id="tanggal2" class="form-control" placeholder="Pilih Tanggal" required/>
                    ...
                    <div class="form-group m-b-15">
                        ...
                        <div class="input-group col-lg-5"> 
                            ...
                            <input type="text" id="lt" name="luas_tanah"  class="form-control nomor text-right" placeholder="0" required> 
                        </div>
                    </div>  
                    <div class="form-group m-b-15">
                        ...
                        <div class="input-group col-lg-5"> 
                            <span class="input-group-addon"><i class="fa fa-handshake text-info"></i></span>
                            <input type="text" id="plt" name="harga"  class="form-control rupiah text-right" placeholder="0" required> 
                        </div>
                    </div>   
                    ...
                    <div class="form-group m-b-15">
                        ...
                        <div class="input-group col-lg-5"> 
                            <span class="input-group-addon"><i class="fa fa-handshake text-info"></i></span>
                            <input type="text" id="takh" name="gross"  class="form-control rupiah text-right" readonly> 
                        </div>
                    </div>   
            </div>
        </div>   
        ...
        <div class="col-lg-6">
            <div class="widget"> 
                ...
                <div class="form-group m-b-15">
                    ...
                    <div class="input-group col-lg-5"> 
                        <div class="input-group" id="daterange-singledate">
                            <input type="text" name="tanggal_jth_tempo" id="tanggal" class="form-control" placeholder="Pilih Tanggal" required/>
                            <span class="input-group-btn">
                                <i class="fa fa-calendar-alt text-info"></i>
                            </span>
                        </div>                            
                    ...
                    <div class="border-top my-10"></div> 
                    <div class="form-group m-b-15">
                        <label class="col-lg-4 font-weight-bold text-lime col-form-label">Rencana Total Pembayaran</label>
                        <div class="input-group col-lg-5"> 
                            <span class="input-group-addon"><i class="fa fa-handshake text-info"></i></span>
                            <input type="text" id="gross_umnya" value="0" class="form-control rupiah text-right" readonly> 
                        </div>
                    </div> 
